...
function RideItem({ ride, actions }) {
  ...
  return (
    <Link href={`/rides/${ride.id}`}>
        <div className="rounded-xl border border-neutral-300 bg-white p-4 shadow-md hover:shadow-xl transition-all duration-150 flex gap-6 min-h-[140px]">
          ...
          <div className="w-[32%] hidden sm:flex flex-col justify-between border-l border-r border-neutral-300 pl-5">
          ...
          <div className="w-[20%] hidden sm:flex flex-col items-end justify-between">
